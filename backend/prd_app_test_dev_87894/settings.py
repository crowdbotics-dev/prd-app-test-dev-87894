"""
Django settings for prd_app_test_dev_87894 project.
...
ROOT_URLCONF = 'prd_app_test_dev_87894.urls'
...
WSGI_APPLICATION = 'prd_app_test_dev_87894.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_app_test_dev_87894 API",
    "DESCRIPTION": "API documentation for prd_app_test_dev_87894 App",
    "VERSION": "v1",
}
